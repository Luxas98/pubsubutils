...
if PUB_SUB_CREDENTIALS:
    ...
    credentials = credentials.with_scopes(['email', 'https://www.googleapis.com/auth/pubsub', 'https://www.googleapis.com/auth/monitoring'])
else:
    credentials = None
...
def callback_info(message):
    ...
    if message.data:
        data = json.loads(message.data)  # TODO: how expensive is this? can we use attributes for everything?
